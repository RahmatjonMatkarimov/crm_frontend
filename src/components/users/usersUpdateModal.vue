            ...
            <div v-if="userModalStore.isUserEditingModalVisible" @click.self="closeModal"
                ...
                <div class="relative w-full h-full flex flex-col overflow-hidden shadow-2xl"
                    ...
                    <div class="flex-1 overflow-y-auto p-6 sm:p-8 space-y-5">
                        ...
                        <div>
                            <label
                                class="block text-[11px] font-medium text-[var(--text-2)] uppercase tracking-wider mb-2">{{ $t('Profil rasmi') }}</label>
                            <label class="cursor-pointer inline-block">
                                <div
                                    class="w-24 h-24 border-2 border-dashed border-[var(--border)] rounded-2xl overflow-hidden flex items-center justify-center hover:border-[var(--text-1)] bg-[var(--border-light)]">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div class="space-y-1">
                                <label
                                    class="block text-[11px] font-medium text-[var(--text-2)] uppercase tracking-wider">{{ $t('JSHSHIR') }}
                                </label>
                    ...
                    <div class="px-6 py-4 flex justify-end gap-3 shrink-0"
                        ...
                        <button @click="saveUser" :disabled="authStore.loading" class="btn btn-primary">
